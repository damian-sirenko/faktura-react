...
export default function ProtocolEntryPage({ preselect = null }) {
  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-[1200px] min-h-screen flex flex-col">
      {/* toast */}
      {toast && (
      ...
      <div className="card-lg border-2 border-blue-200 bg-blue-50/60">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <h1 className="text-2xl font-bold">Dodaj / edytuj wpis protokołu</h1>
        </div>
      </div>
      ...
      <div className="p-4 border-b">
        ...
        {pickedClient ? (
          <div className="mt-2 text-sm">
            Wybrano: <b>{pickedClient?.name || pickedClient?.Klient || "—"}</b>{" "}
                    ...
                    <React.Fragment key={i}>
                      <div className="relative">
                        <input
                          ...
                          onBlur={(e) => {
                            const canon = canonicalizeToolName(e.target.value);
                          ...
                          onChange={(e) => {
                            ...
                            if (activeSuggestRow !== i) setActiveSuggestRow(i);
              ...
              <table className="table w-full table-auto min-w-[1100px] print-table">
                <thead>
                  <tr className="bg-gray-50">
                    ...
                    <th className="w-[26%] md:w-[28%] lg:w-[30%]">Narzędzie</th>
                ...
                <tbody>
                  {viewEntries.map(({ row, i: origIndex }, displayIndex) => {
                    const toolsList = (row.tools || []).filter((t) => t?.name);
                      ...
                      <React.Fragment key={`${row.date}-${origIndex}`}>
                        <tr className="align-top">
                          ...
                          <td className="align-top break-words">
                            {toolsList.length ? (
                              toolsList.map((t, k) => (
                                <div key={k} className="leading-tight truncate">
                                  {t.name}
                                </div>
                              ))
                            ) : (
                            ...
                            <div className="min-h-[42px]">
                              {tStaffSig ? (
                                <button
                                  ...
                                  onClick={() =>
                                    removeStaffSignature(origIndex, "transfer")
                                  }
                            ...
                            <div className="min-h-[42px] mt-1">
                              {rStaffSig ? (
                                ...
                                <button
                                  ...
                                  onClick={() => signStaff(origIndex, "return")}
